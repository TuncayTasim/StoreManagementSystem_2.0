        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActionToken = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    StatusId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Shelves_ActionTypes_ActionId",
                        column: x => x.ActionId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Warehouses_ActionTypes_ActionId",
                        column: x => x.ActionId,
                        principalTable: "ActionTypes",
                        principalColumn: "ActionId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShelfRestocks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ShelfRestocks_Shelves_ShelfId",
                        column: x => x.ShelfId,
                        principalTable: "Shelves",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PriceBought = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WarehouseRestocks_Warehouses_WarehouseId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sales_ShelfId",
                table: "Sales",
                column: "ShelfId");

            migrationBuilder.CreateIndex(
                name: "IX_ShelfRestocks_ShelfId",
                table: "ShelfRestocks",
                column: "ShelfId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Shelves_ActionId",
                table: "Shelves",
                column: "ActionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WarehouseRestocks_WarehouseId",
                table: "WarehouseRestocks",
                column: "WarehouseId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Warehouses_ActionId",
                table: "Warehouses",
                column: "ActionId");
